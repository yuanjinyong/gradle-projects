...
public interface TabbedPaneListener {
	...
	/**
	 * Implementations of this method allow users to have more fine grained control on closing of individual tabs
	 * depending on component state.
	 *
	 * @param tab
	 *            the Tab that will be closing.
	 * @param component
	 *            the child component of the tab.
