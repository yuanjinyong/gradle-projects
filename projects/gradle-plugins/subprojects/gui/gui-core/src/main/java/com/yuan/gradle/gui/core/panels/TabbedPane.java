...
public class TabbedPane extends JPanel {
    ...
    public TabbedPane(final int type) {
        ...
        URL url = TabbedPane.class.getResource("/image/close_normal.png");
        closeInactiveButtonIcon = new ImageIcon(url);
        url = TabbedPane.class.getResource("/image/close_highlight.png");
    ...
    public Tab addTab(String title, Icon icon, final Component component, String tip) {
